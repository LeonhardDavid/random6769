...
<!-- Begin code -->
	...
	<div class="container colorcust pad bg1 d-none d-lg-block">
			<div class="row justify-content-center align-content-center ">
		  		<div class="col-md-3 flex-column">
						<i class="far fa-credit-card"></i>
						Raport pret calitate impecabil
					</div>
		  		<div class="col-md-3 flex-column">
						<i class="fas fa-hand-holding-usd"></i>
						Retur fara explicatii in 15 zile
		  		</div>
		  		<div class="col-md-3 flex-column">
						<i class="fas fa-fighter-jet"></i>
						Produse originale New York, SUA
					</div>
		  		<div class="col-md-3 flex-column">
						<i class="fas fa-shipping-fast"></i>
						Livrare gratuita de la 290 lei
		  		</div>
			</div>
		</div>
		<div class="container pad1">

			<div class="row-flex bg2 w-50 d-none d-lg-block">
				<br><br><br><br><br><br><br>
				<div class="flex-column justify-content-center txt">
						It delivers lightweight lockdown and responsive Air Zoom cushioning for explosive play-making on the court
				</div>
			</div>
