...
<body>
	...
	<div class="container my-2 px-4 py-2">
		...
		<div class="container px-0">
			...
			<div class="container blue-bg py-3">
				<div class="row my-3">
					<div class="col-md-6 pad-r">
						<label class="container-radio border-radio text-center">
							<span class="blue-txt font-md">Vreau cont</span>
						  <input type="radio" checked="checked" name="account-option">
						  <span class="checkmark"></span>
						</label>
					</div>
					<div class="col-md-6 pad-l">
						<label class="container-radio border-radio text-center">
							<span class="blue-txt font-md">Nu vreau cont</span>
						  <input type="radio" name="account-option">
						  <span class="checkmark"></span>
						</label>
					</div>
				</div>
				...
				<div class="row my-3 mx-2 py-3 white-bg">
					...
					<div class="row col-11 mt-3 px-0 mx-auto">
						<div class="col-md-6 pad-l">
							<label for="basic-url" class="font-lg">Email:</label>
							<div class="input-group mb-3">
							  <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
							</div>
						</div>

						<div class="col-md-6 pad-r" id="password">
							<label for="basic-url" class="font-lg">Parola:</label>
							<div class="input-group mb-3">
							  <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
							</div>
						</div>
			...
			<div class="container blue-bg pb-5">
				...
				<div class="row my-3 mx-2 py-3 white-bg">
					...
					<div class="col-12 mt-3">
						<div class="row">
							<div class="col-11 px-0 mx-auto">
								<h5 class="bold-txt"> Persoana de contact: </h5>
							</div>
						<div class="row col-11 px-0 mx-auto">
							<div class="col-md-6 pad-l">
								<label for="basic-url" class="font-md">Nume si prenume:</label>
								<div class="input-group mb-3">
								  <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
								</div>
							</div>
							...
							<div class="col-md-6 pad-r">
								<label for="basic-url" class="font-md">Telefon:</label>
								<div class="input-group mb-3">
								  <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
								</div>
							</div>
							...
							<div class="row">
								<div class="col-11 px-0 mx-auto">
									<h5 class="bold-txt"> Adresa de livrare: </h5>
								</div>
							<div class="row col-11 px-0 mx-auto">
								<div class="col-md-6 pad-l">
									<label for="basic-url" class="font-md">Judet:</label>
									<div class="input-group mb-3">
									    <select class="custom-select" id="inputGroupSelect01">
										    <option selected>Alegeti...</option>
								...
								<div class="col-md-6 pad-r">
									<label for="basic-url" class="font-md">Localitate:</label>
									<div class="input-group mb-3">
									   <select class="custom-select" id="inputGroupSelect01">
										    <option selected>Alegeti...</option>
										    <option value="Alba">Alba</option>
								...
								<div class="col-12 pad-l pad-r">
									<label for="basic-url" class="font-md">Adresa:</label>
									<div class="input-group mb-3">
									  <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
									</div>
								</div>
